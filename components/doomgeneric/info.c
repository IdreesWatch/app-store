...
#include <string.h>
const state_t states_rom[NUMSTATES] = {
#else
...
{
    states = heap_caps_malloc(sizeof(states_rom), MALLOC_CAP_SPIRAM);
    memcpy(states, states_rom, sizeof(states_rom));
    
    mobjinfo = heap_caps_malloc(sizeof(mobjinfo_rom), MALLOC_CAP_SPIRAM);
